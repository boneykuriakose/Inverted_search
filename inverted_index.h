...
/* File validation */
void validate_n_store_filenames(file_node_t **,char *filename[]);
...
void read_datafile(file_node_t *, main_node_t **);
int insert_at_last_main(main_node_t **head, char *word,char *filename);
int update_link_table(main_node_t **main_node,char *filename);
